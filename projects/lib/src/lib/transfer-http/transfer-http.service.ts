...
export class TransferHttpService {
  ...
  request<T>(
    ...
    return this.getData<T>(
      ...
      uri,
      options,
      (method: string, url: string | Request, options: any) => {
  ...
  options<T>(
    ...
    return this.getData<T>(
      ...
      url,
      options,
      (_method: string, url: Request | string, options: any) => {
        return this.httpClient.options<T>(
          typeof url !== 'string' ? url.url : url,
          options
        );
      }
